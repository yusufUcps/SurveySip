		...
		<div class="col-lg-12">
			<div class="row">
				<div class="col-sm-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Tipe Jawaban</label>
							<select name="type" id="type" class="custom-select custom-select-sm">
								<?php if(isset($id)): ?>
								<option value="" disabled="" selected="">Silahkan Pilih Disini</option>
								<?php endif; ?>
								<option value="radio_opt" <?php echo isset($type) && $type == 'radio_opt' ? 'selected':'' ?>>Jawaban Tunggal/Radio Button</option>
								<option value="check_opt" <?php echo isset($type) && $type == 'check_opt' ? 'selected':'' ?>>Banyak Jawaban /Check Boxes</option>
								<option value="textfield_s" <?php echo isset($type) && $type == 'textfield_s' ? 'selected':'' ?>>Jawaban Teks/ Text Area</option>
							</select>
						</div>
				...
				<div class="col-sm-6">
					...
					<div class="preview">
						<?php if(!isset($id)): ?>
						<center><b>Pilih Tipe Jawaban Terlebih Dahulu</b></center>
						<?php else: ?>
							...
							?>
						      ...
						      <div class="col-sm-12 text-center">
						      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="<?php echo $type ?>($(this))"><i class="fa fa-plus"></i> Tambah</button>
						      </div>
						      </div>
						    </div>
						</div>
						...
						<?php else: ?>
								<textarea name="frm_opt" id="" cols="30" rows="10" class="form-control" disabled="" placeholder="Tuliskan Sesuatu Disini..."></textarea>
						<?php endif; ?>
						<?php endif; ?>
					</div>
				</div>
...
<div id="check_opt_clone"  style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_check($(this))"><i class="fa fa-plus"></i> Tambah</button>
      </div>
      </div>
    </div>
</div>
<div id="radio_opt_clone" style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_radio($(this))"><i class="fa fa-plus"></i> Tambah</button>
      </div>
      </div>
    </div>
</div>
