...
<div class="col-lg-12">
	...
	<div class="row">
		...
		while($row=$survey->fetch_assoc()):
			if($row['status_r'] == 'sedang berbagi'){?>
			...
			<div class="card card-outline card-primary">
              ...
              <div class="card-body" style="display: block;">
               ...
               <div class="row">
				...
				<p> poin yang dibutuhkan : <?php echo $row['poin_r'] ?> </p>
		...
		?>
	<?php endwhile; 
		$blok = $conn->query("SELECT id from survey_set where status_r = 'sedang berbagi'")->num_rows;
		if ($blok == 0) {
		?>
			<div class="w-100">
				<center><b>Tidak ditemukan.</b></center>
			</div>
		<?php
		}
		?>
