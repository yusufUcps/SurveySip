  			...
  			<div class="card col-md-4">
  				<div class="card-body">
  					<form id="login-form" >
  						...
  						<center> <button class="btn-sm btn-block btn-wave col-md-4 btn-primary">Login</button> <a href="daftar.php">Daftar</a></center>
					</form>
  				</div>
  			</div>
  		</div>
	...
	$('#login-form').submit(function(e){
		...
		$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
			...
			success:function(resp){
				if(resp == 1){
					location.href ='survey.php?page=dashboard';
				}else{
